...
###~~~~~~~~~~ K00370 MSA_TIGR01580_weighted_subset_phylum_nmax100_v1_with_soil_seqs_1000
msafpath="data/K00370/msas/MSA_TIGR01580_weighted_subset_phylum_nmax100_v1_with_soil_seqs_1000.aln-fasta"
structdir="data/K00370/structures"
outdir="out/K00370/TIGR01580_weighted_subset_phylum_nmax100_v1_with_soil_seqs_1000"
...
runsca -msa $msafpath -o $outdir \
    ...
    --kstar $kstar \
    --pbar \
    --nodendro --save_all --seed 6857 --load_data ${outdir}/sca_results
