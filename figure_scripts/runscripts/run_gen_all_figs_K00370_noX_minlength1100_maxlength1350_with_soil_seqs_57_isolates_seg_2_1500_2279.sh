...
# RUN=(1 2 3 4 5 5b 5pymol 6 6b 6pymol 7 5all 6all)
# RUN=(5 5b 6 6b)
# RUN=(5all 6all)
# RUN=(5pymol 6pymol)
...
datdirbase=out/K00370/TIGR01580_noX_minlength1100_maxlength1350_with_soil_seqs_57_isolates_seg_2_1500_2279
outdirbase=out/figures/TIGR01580_noX_minlength1100_maxlength1350_with_soil_seqs_57_isolates_seg_2_1500_2279
...
groups_dir=${datdirbase}/sca_groups_remapped
scores_dir=${datdirbase}/pdb_sectors_remapped
