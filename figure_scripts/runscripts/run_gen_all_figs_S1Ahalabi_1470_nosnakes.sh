...
datdirbase=out/S1Ahalabi/S1Ahalabi_1470_nosnakes
outdirbase=out/figures/S1Ahalabi_1470_nosnakes
...
if should_run 5pymol; then
    ...
    scaffolds=(
        "gi|4139558|pdb|3TGI|E__vertebrate|warm|Rattus"
    )
    groups=(
        "0 1"
        "1 2"
