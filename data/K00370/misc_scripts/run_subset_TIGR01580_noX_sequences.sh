...
python data/K00370/misc_scripts/subset_TIGR01580_sequences.py \
    -i data/K00370/seqs/TIGR01580_noX.fasta \
    -n ${nmax} \
    -o data/K00370/seqs/TIGR01580_noX_weighted_subset_${rank}_nmax${nmax}_v1.fasta \
    -sm data/K00370/misc/metadata_TIGR01580_noX.tsv \
    -tm data/K00370/misc/taxids_TIGR01580_metadata.tsv \
    -ro data/K00370/misc/rankcounts_TIGR01580_noX \
    -r $rank --seed $((43 + seed))
